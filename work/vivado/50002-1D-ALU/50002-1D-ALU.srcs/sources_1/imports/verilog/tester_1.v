...
module tester_1 (
  ...
  localparam END_testerfsm = 5'd19;
  ...
  wire [5-1:0] M_slowCounter_value;
  counter_4 slowCounter (
    .clk(clk),
    .rst(rst),
    .value(M_slowCounter_value)
  );
  ...
  always @* begin
    ...
    case (M_testerfsm_q)
      ...
      ADD1_testerfsm: begin
        counter = M_slowCounter_value;
        M_testerrom_address = M_slowCounter_value;
        counter = M_slowCounter_value;
