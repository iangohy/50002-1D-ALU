...
module alu_6 (
  ...
  wire [(5'h10+0)-1:0] M_mux4_out;
  reg [(5'h10+0)*2-1:0] M_mux4_s;
  reg [(5'h10+0)-1:0] M_mux4_a;
  reg [(5'h10+0)-1:0] M_mux4_b;
  reg [(5'h10+0)-1:0] M_mux4_c;
  reg [(5'h10+0)-1:0] M_mux4_d;
  
  genvar GEN_mux40;
  generate
  for (GEN_mux40=0;GEN_mux40<5'h10;GEN_mux40=GEN_mux40+1) begin: mux4_gen_0
    mux_4_14 mux4 (
      .s(M_mux4_s[GEN_mux40*(2'h2)+(2'h2)-1-:(2'h2)]),
      .a(M_mux4_a[GEN_mux40*(1)+(1)-1-:(1)]),
      .b(M_mux4_b[GEN_mux40*(1)+(1)-1-:(1)]),
      .c(M_mux4_c[GEN_mux40*(1)+(1)-1-:(1)]),
      .d(M_mux4_d[GEN_mux40*(1)+(1)-1-:(1)]),
      .out(M_mux4_out[GEN_mux40*(1)+(1)-1-:(1)])
    );
  end
  endgenerate
  ...
  always @* begin
    ...
    M_mux4_s[0+1-:2] = {5'h10{alufn[5+0-:1]}};
    M_mux4_s[2+1-:2] = {5'h10{alufn[4+0-:1]}};
    M_mux4_a = miniMuxRes;
    M_mux4_b = shift;
    M_mux4_c = boole;
    M_mux4_d = cmp;
